...
def setup_library_view(app, parent):
    ...
    app.library_tree = ttk.Treeview(
        ...
        displaycolumns=("Title", "ASIN", "Author", "Narrator", "Series", "Duration", "Date Added","Status", "File Path"),
        show="headings", 
    ...
    app.library_tree.bind("<Double-1>", app.playback_presenter.master_play)
    ...
    ttk.Button(local_btn_frame, text="Remove from List", command=lambda:app.library_manager.handle_remove_clicked(app)).pack(side=tk.LEFT, padx=5)
