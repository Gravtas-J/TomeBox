...
def setup_menu_bar(app):
    ...
    app.appearance_menu.add_radiobutton(label="Light Default", variable=app.ui_state.palette, value="light", command=lambda: app.palette_controller.apply_palette("light"))
    app.appearance_menu.add_radiobutton(label="Dark Charcoal", variable=app.ui_state.palette, value="dark", command=lambda: app.palette_controller.apply_palette("dark"))
    app.appearance_menu.add_radiobutton(label="Terminal Green", variable=app.ui_state.palette, value="terminal", command=lambda: app.palette_controller.apply_palette("terminal"))
    app.appearance_menu.add_separator()
    app.appearance_menu.add_radiobutton(label="Solarized Dark", variable=app.ui_state.palette, value="solarized_dark", command=lambda: app.palette_controller.apply_palette("solarized_dark"))
    app.appearance_menu.add_radiobutton(label="Solarized Light", variable=app.ui_state.palette, value="solarized_light", command=lambda: app.palette_controller.apply_palette("solarized_light"))
    app.appearance_menu.add_separator()
    app.appearance_menu.add_radiobutton(label="Dracula", variable=app.ui_state.palette, value="dracula", command=lambda: app.palette_controller.apply_palette("dracula"))
    app.appearance_menu.add_radiobutton(label="Nordic Slate", variable=app.ui_state.palette, value="nord", command=lambda: app.palette_controller.apply_palette("nord"))
    app.appearance_menu.add_radiobutton(label="Cyberpunk", variable=app.ui_state.palette, value="cyberpunk", command=lambda: app.palette_controller.apply_palette("cyberpunk"))
    ...
    app.file_menu.add_separator()
    app.file_menu.add_command(label="Enable Web Server", command=app.cloud_server_controller.toggle_web_server)
    ...
    app.file_menu.add_command(label="Remove Firewall Rule", command=app.cloud_server_controller.remove_firewall_rule_prompt)
    app.file_menu.add_command(label="Add Firewall Rule", command=app.cloud_server_controller.add_firewall_rule_prompt)
    app.file_menu.add_separator()
